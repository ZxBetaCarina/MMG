...
namespace SweetSugar.Scripts.GUI
{
    ...
    public class AnimationEventManager : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            ...
            if (name == "PrePlay")
            {
                //settingButton.localPosition -= new Vector3(200f, 0f, 0f);
            }
            if (name == "PreFailed")
            {
//              SoundBase.Instance.PlayOneShot(SoundBase.Instance.gameOver[0]);
        ...
        {
            GameObject.Find("SettingsButton").LeanScaleX(1f, 0f);
            ...
            if (gameObject.name == "Settings" && LevelManager.GetGameStatus() == GameState.Playing)
            {
                //SweetSugar.Scripts.PUNScripts.GameplaySceneScript.Instance.Exit();
            ...
            //Debug.Log("GameState: " + LevelManager.GetGameStatus());
            gameObject.SetActive(false);
        }
        ...
        public void Buy(GameObject pack)
        {
			...
			//#endif
			//            Debug.Log(pack.transform.Find("Count"));
			int cost = int.Parse(pack.transform.Find("Count").GetComponent<TextMeshProUGUI>().text);

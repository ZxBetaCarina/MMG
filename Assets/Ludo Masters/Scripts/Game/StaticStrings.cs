namespace AssemblyCSharp
{
    public static class StaticStrings
    {
        ...
        public static string ITunesAppID = "11111111";
        ...
        public static string PlayFabTitleID = "8120B";
        public static string PhotonAppID = "6578a3ec-3295-43cf-a668-409aa0d26833";
        public static string PhotonChatID = "6d887cae-feb7-4a52-8468-be28ed65e5aa";

        // Unity Ads APP IDS
        public static string unityAdsIOSID = "UNITY ADS IOS ID";
        public static string unityAdsAndroidID = "UNITY ADS ANDROID ID";
        ...
        public static string facebookShareLinkTitle = "I'm playing Ludo Online!. Available on Android and iOS.";

        // Share private room code
        public static string SharePrivateLinkMessage = "Join me in Ludo Online. My PRIVATE ROOM CODE is:";
        public static string SharePrivateLinkMessage2 = "Download Ludo Online from:";
        public static string ShareScreenShotText = "I finished game in Ludo Online. It's my score :-) Join me and download Ludo Online:";

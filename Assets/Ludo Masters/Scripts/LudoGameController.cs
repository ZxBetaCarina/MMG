...
public class LudoGameController : PunBehaviour, IMiniGame
{
    ...
    void Start()
    {
        ...
        // Debug.Log("SCALE: " + scalerWidth + " - " + scalerWidth / boardWidth);

        // Debug.Log("Width: " + gameBoardScaler.GetComponent<RectTransform>().rect.width + " - " + Screen.width);

        // GameObject mainCanvas = transform.Find("Canvas").gameObject;

        // float boardSize = (gameBoardScaler.GetComponent<RectTransform>().rect.width * mainCanvas.GetComponent<RectTransform>().localScale.x);

        // if (boardSize > Camera.main.pixelWidth)
        // {
        //     Debug.Log("SS: " + (Camera.main.pixelWidth / boardSize));
        //     gameBoard.GetComponent<RectTransform>().localScale = new Vector2(gameBoard.GetComponent<RectTransform>().localScale.x * Camera.main.pixelWidth / boardSize,
        //      gameBoard.GetComponent<RectTransform>().localScale.y * Camera.main.pixelWidth / boardSize);
        // }

        // gUIController = GameGui.GetComponent<GameGUIController>();
        StartCoroutine(scaleBoard());


    }

    private IEnumerator scaleBoard()
    {
    ...
    void Update()
    {
        ...
        //Debug.Log("Width: " + (gameBoardScaler.GetComponent<RectTransform>().rect.width * mainCanvas.GetComponent<RectTransform>().localScale.x) + " - " + Camera.main.pixelWidth);
    }

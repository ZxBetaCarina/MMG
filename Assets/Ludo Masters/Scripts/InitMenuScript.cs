...
#else
        //Advertisement.Initialize(StaticStrings.unityAdsAndroidID);
#endif
...
//          CookiesDialog.SetActive(true);
        ...
        // AdsManager.Instance.adsScript.LoadHouse();
...
//            rateWindow.SetActive(true);
    ...
    {
        Application.OpenURL("https://sites.google.com/site/glowaspolicy/");
    }
    ...
    {
        // FB.AppRequest(
        //     message: StaticStrings.facebookInviteMessage,
    ...
    public void showLeaderboards()
    {
        ...
        // AdsManager.Instance.adsScript.ShowAd(AdLocation.LeaderboardsWindow);
        GameManager.Instance.playfabManager.GetLeaderboards();
    }

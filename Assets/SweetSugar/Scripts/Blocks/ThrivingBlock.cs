...
namespace SweetSugar.Scripts.Blocks
{
    ...
    public class ThrivingBlock : Square
    {
        ...
        void OnDisable()
        {
            ...
            Achievements.chocolateAchievementCount += 1;
            PlayerPrefs.SetInt("chocolateAchievementCount", Achievements.chocolateAchievementCount);
            AchievementManager.instance.checkChocoAchievement(Achievements.chocolateAchievementCount);

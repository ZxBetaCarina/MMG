...
namespace SweetSugar.Scripts.GUI
{
    ...
    public class DailyReward : MonoBehaviour
    {
        ...
        public void Ok()
        {
            ...
            Achievements.timesCollectedBonus += 1;
            PlayerPrefs.SetInt("timesCollectedBonus", Achievements.timesCollectedBonus);
            AchievementManager.instance.checkdailyBonusAchievement(Achievements.timesCollectedBonus);

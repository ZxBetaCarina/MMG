            ...
            set
            {
                ...
                switch (value)
                {
                    ...
                    case GameState.Tutorial://tutorial state
                        ...
                        //GameObject.Find("SettingsButton").transform.LeanScaleX(1f, 0f);
                        break;
                    ...
                    case GameState.PreFailed://chance to continue the game, shows menu PreFailed
                        ...
                        LeanTween.delayedCall(3, () =>
                        {
                            ...
                            preFailedGameObject.GetComponent<PreFailed>().Close();
                        });
                        break;
                    ...
                    */
                    ...
                    case GameState.GameOver://game over
                        ...
                        Achievements.timesLevelFailed += 1;
                        PlayerPrefs.SetInt("timesLevelFailed", Achievements.timesLevelFailed);
                        AchievementManager.instance.checklevelFailedAchievement(Achievements.timesLevelFailed);
                    ...
                    case GameState.Win://shows MenuComplete
                        ...
                        //GameplaySceneScript.Instance.gameEnded = true;
                        //GameplaySceneScript.Instance.RPCOpponentScore();
                        //MenuReference.THIS.MenuComplete.transform.Find("Final Score Panel").gameObject.SetActive(true);
						#region Jeeto24 Result Update API
						//if (GameplaySceneScript.Instance.opponentEnded && GameplaySceneScript.Instance.gameEnded)
      //                  {
      //                      if (GameplaySceneScript.Instance.Player_Score > GameplaySceneScript.Instance.Opponent_Score)
      //                      {
      //                          GameplaySceneScript.Instance.Winner_Score_Text.text = "Score : " + GameplaySceneScript.Instance.Player_Score.ToString();
      //                          GameplaySceneScript.Instance.Runner_Score_Text.text = "Score : " + GameplaySceneScript.Instance.Opponent_Score.ToString();
      //                          GameplaySceneScript.Instance.Winner_Name_Text.text = MultiplayerNetworkManager.PlayerName;
      //                          GameplaySceneScript.Instance.Runner_Name_Text.text = MultiplayerNetworkManager.OpponentName;
      //                          GameplaySceneScript.Instance.WinnerText.text = "You Win";
      //                      }
      //                      else if (GameplaySceneScript.Instance.Player_Score < GameplaySceneScript.Instance.Opponent_Score)
      //                      {
      //                          GameplaySceneScript.Instance.Winner_Score_Text.text = "Score : " + GameplaySceneScript.Instance.Opponent_Score.ToString();
      //                          GameplaySceneScript.Instance.Runner_Score_Text.text = "Score : " + GameplaySceneScript.Instance.Player_Score.ToString();
      //                          GameplaySceneScript.Instance.Winner_Name_Text.text = MultiplayerNetworkManager.OpponentName;
      //                          GameplaySceneScript.Instance.Runner_Name_Text.text = MultiplayerNetworkManager.PlayerName;
      //                          GameplaySceneScript.Instance.WinnerText.text = "Opponent Win";
      //                      }
      //                      else
      //                      {
      //                          //GameplaySceneScript.Instance.Opponent_Score_Text.text = GameplaySceneScript.Instance.Opponent_Score.ToString();
      //                          GameplaySceneScript.Instance.WinnerText.text = "Its a Draw";
      //                      }
      //                  }
      //                  else
      //                  {
      //                      //GameplaySceneScript.Instance.Opponent_Score_Text.text = "";
      //                      GameplaySceneScript.Instance.WinnerText.text = "Waiting for opponent to finish";
      //                  }
						#endregion
                    ...
                    case GameState.Pause:
                        Debug.Log("Game status changes to PAUSE");
                        break;
                }
            }
        }
...
// #endif
            ...
            {
                if (Input.GetMouseButtonDown(0) && Item.switchingCandy)
                {
                        //Debug.Log("Item.switchingCandy: " + Item.switchingCandy);
                        var hit = Physics2D.OverlapPoint(Camera.main.ScreenToWorldPoint(Input.mousePosition),
                            1 << LayerMask.NameToLayer("Item"));
                        //Debug.Log("Hit: " + hit);
                        //Debug.Log("GameState: " + gameStatus);
                        if (hit != null)
                        {
